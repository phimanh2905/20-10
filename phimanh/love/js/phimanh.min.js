...
(function(b){b(document).ready(function(a){a("body").vegas({slides:[{src:"https://i.imgur.com/36GsFBT.jpg"}],preloadImage:!0,overlay:!0});a("#txt").typist({speed:12}).typistPause(2E3).typistAdd(" \u2013 Chào em\n").typistPause(2E3).typistAdd(" \u2013 Em có muốn sau khi chết...").typistPause(1500).typistAdd(" sẽ có tên trong gia phả nhà anh không? :x")})})(jQuery);
